...
namespace KBEngine
{
	...
	// Please inherit and implement "class Hall : HallBase"
	public abstract class HallBase : Entity
	{
		...
		{
			baseEntityCall = new EntityBaseEntityCall_HallBase(id, className);
		}

		public override void onGetCell()
		{
			cellEntityCall = new EntityCellEntityCall_HallBase(id, className);
		}
		...
		{
			ScriptModule sm = EntityDef.moduledefs["Hall"];
